  ...
  return (
    <>
      ...
      <button
        ...
        className="w-14 h-14 bg-gradient-to-r from-[#5b4dcf] to-[#a280ff] rounded-full shadow-lg flex items-center justify-center text-white hover:scale-110 transition-transform duration-200"
      >
